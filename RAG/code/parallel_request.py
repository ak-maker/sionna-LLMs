...
#             log.warning(f"Bitch see this {response['message']}\n,Request {self.task_id} failed with Exception {e}")
...
#
# os.environ["OPENAI_API_KEY"] = "sk-YdQbTYCGPFCfTq3QqUq8yA"
# @app.command()
# def cli(
...
#     model: Annotated[str, typer.Option(help="the LLM/Embedding model to be called")] = "gpt4-0125-preview",
