<table>
        <td style="padding: 0px 0px;">
            <a href=" https://colab.research.google.com/github/NVlabs/sionna/blob/main/examples/5G_NR_PUSCH.ipynb" style="vertical-align:text-bottom">
        ...
        <td class="wy-breadcrumbs-aside" style="padding: 0 30px;">
            <a href="https://github.com/nvlabs/sionna/blob/main/examples/5G_NR_PUSCH.ipynb" style="vertical-align:text-bottom">
                <i class="fa fa-github" style="font-size:24px;"></i>
                View on GitHub
            </a>
        </td>
        <td class="wy-breadcrumbs-aside" style="padding: 0 35px;">
            <a href="../examples/5G_NR_PUSCH.ipynb" download target="_blank" style="vertical-align:text-bottom">
...
## Table of Contents<a class="headerlink" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Table-of-Contents" title="Permalink to this headline"></a>
 
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#GPU-Configuration-and-Imports">GPU Configuration and Imports</a>
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#A-Hello-World-Example">A Hello World Example</a>
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Carrier-Configuration">Carrier Configuration</a>
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Understanding-the-DMRS-Configuration">Understanding the DMRS Configuration</a>
 
  - <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Configuring-Multiple-Layers">Configuring Multiple Layers</a>
  - <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Controlling-the-Number-of-DMRS-Symbols-in-a-Slot">Controlling the Number of DMRS Symbols in a Slot</a>
  - <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#How-to-control-the-number-of-available-DMRS-ports?">How to control the number of available DMRS ports?</a>


- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Transport-Blocks-and-MCS">Transport Blocks and MCS</a>
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Looking-into-the-PUSCHTransmitter">Looking into the PUSCHTransmitter</a>
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#Components-of-the-PUSCHReceiver">Components of the PUSCHReceiver</a>
- <a class="reference external" href="https://nvlabs.github.io/sionna/examples/5G_NR_PUSCH.html#End-to-end-PUSCH-Simulations">End-to-end PUSCH Simulations</a>
